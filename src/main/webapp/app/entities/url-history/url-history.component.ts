...
export class UrlHistoryComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: UrlHistory) {
        return item.id;
    }
    registerChangeInUrlHistories() {
        this.eventSubscriber = this.eventManager.subscribe('urlHistoryListModification', (response) => this.reset());
    }
